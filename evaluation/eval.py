...
all_tgt_image_folders={
    ...
    # ---
    "1_ddim+p2p":"/annotation_images",#"/ddim+p2p/annotation_images",
    ...
    "1_null-text-inversion+p2p":"/annotation_images",#/null-text-inversion+p2p
    "1_negative-prompt-inversion+p2p":"/annotation_images",#/negative-prompt-inversion+p2p
    "1_stylediffusion+p2p":"/stylediffusion+p2p/annotation_images",
    "1_directinversion+p2p":"/annotation_images",#/directinversion+p2p
    "1_InfEdit+p2p":"/annotation_images",
    # ---
    "1_ddim+masactrl":"/annotation_images",
    "1_directinversion+masactrl":"/annotation_images",
    # ---
    ...
    if evaluate_whole_table:
        for key in all_tgt_image_folders:
            if key[0] in tgt_methods:
                tgt_image_folders[key]=out_path+all_tgt_image_folders[key]
    else:
        for key in tgt_methods:
            tgt_image_folders[key]=out_path+all_tgt_image_folders[key]
    
    result_path=os.path.join(out_path,"evaluation_result.csv")#args.result_path
    if os.path.exists(result_path):
        print(f"exist {result_path}")
        exit()
